...
class Unet(object):
    _defaults = {
        "model_path"        : 'logs/Epoch100-Total_Loss0.0658-Total_Loss1-0.0132-Total_Loss2-0.0527-Val_Loss0.0611-Val_Loss1-0.0163-Val_Loss2-0.0448.pth',
    ...
    def generate(self):
        ...
        if self.num_classes == 2:
            ...
            self.colors = [(0, 0, 0), (0, 128, 0), (128, 128, 0), (0, 0, 128), (128, 0, 128), (0, 128, 128),
